...
namespace NORCE.Drilling.EarthMagneticField.PseudoConstructorsWriter
    {
    class Writer
    {     
        private static readonly string NAMESPACE = "NORCE.Drilling.EarthMagneticField.ModelShared";    
        ...
        public static bool ChangeICollectionToList(DirectoryInfo directory)
        {
            ...
            {                
                ...
                string filePath = fullPath + "EarthMagneticFieldMergedModel.cs";

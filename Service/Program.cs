...
using System.IO;
using NORCE.Drilling.EarthMagneticField.Service;
...
var basePath = "/EarthMagneticField/api";
var scheme = "http";
...
string exposedModel = "wwwroot/json-schema/EarthMagneticFieldMergedModel.json";
